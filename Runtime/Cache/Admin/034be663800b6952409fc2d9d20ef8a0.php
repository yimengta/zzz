  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td width="5%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"><?php echo ($v["role_id"]); ?></span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"><?php echo ($v["role_name"]); ?></span></div></td>
        <td height="20" bgcolor="d3eaef" class="STYLE6" align="center">
        <a href="<?php echo U('upd',array('role_id'=>$v['role_id']));?>"><span class="STYLE10">编辑|</span></a>
        <a href="<?php echo U('distribute',array('role_id'=>$v['role_id']));?>"><span class="STYLE10">分配权限|</span></a>
