  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6" align="left"><div align="center"><span class="STYLE10">权限名称</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">权限pid</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">操作控制器</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">操作方法</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">全路径</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">等级</span></div></td>
      ...
      <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td width="5%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"><?php echo ($v["auth_id"]); ?></span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6" align="left"><div align="center"><span class="STYLE10"><?php echo (str_repeat('&emsp;',$v['auth_level']*4)); echo ($v["auth_name"]); ?></span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"><?php echo ($v["auth_pid"]); ?></span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"><?php echo ($v["auth_c"]); ?></span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"><?php echo ($v["auth_a"]); ?></span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"><?php echo ($v["auth_path"]); ?></span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10"><?php echo ($v["auth_level"]); ?></span></div></td>
        <td height="20" bgcolor="d3eaef" class="STYLE6" align="center">
        <a href="<?php echo U('tianjia',array('auth_id'=>$v['auth_id']));?>"><span class="STYLE10">编辑|</span></a>
        <a href="<?php echo U('tianjia',array('auth_id'=>$v['auth_id']));?>"><span class="STYLE10">添加|</span></a>
